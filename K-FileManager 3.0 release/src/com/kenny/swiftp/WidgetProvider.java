...
public class WidgetProvider extends AppWidgetProvider
{
	              ...
	              AppWidgetManager appWidgetManager, int[] appWidgetIds)
        {
	      ...
	      // register new Widgets, for them to be Updated by
	      // WidgetUiUpdater
	      WidgetUiUpdater.registerWidgets(appWidgetIds, context,
		            appWidgetManager);
	      ...
	      PendingIntent actionPendingIntent = PendingIntent.getBroadcast(
		            context, 0, active, 0);
	      remoteViews.setOnClickPendingIntent(R.id.widget_button_off,
		            actionPendingIntent);
	      remoteViews.setOnClickPendingIntent(R.id.widget_button_on,
		            actionPendingIntent);
	      
	      // set the right state, according to the FTP Server
	      if (FTPServerService.isRunning())
	      {
		    remoteViews.setViewVisibility(R.id.widget_button_on,
			          View.VISIBLE);
		    remoteViews.setViewVisibility(R.id.widget_button_off,
			          View.GONE);
	      }
	      else
	      {
        ...
        public void onReceive(Context context, Intent intent)
        {
	      ...
	      if (intent.getAction().equals(ACTION_WIDGET_BUTTON))
	      {
		    ...
		    /*
		     * After handling onReceive this Object will be
		     * destroyed by the OS. BroadcastReceivers and
		     * WidgetProviders shouldn't handle asynchronous
		     * actions, like UI Updates.
		     */
		    
		    // start or stop FTP Service
		    Intent intentFTP = new Intent(context,
