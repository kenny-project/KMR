...
public class HistoryParser extends DefaultHandler
{
   ...
   private ArrayList<HistoryBean> lists;
   ...
   {
      lists = new ArrayList<HistoryBean>();
   }
   ...
   public ArrayList<HistoryBean> parseJokeByFile(Context context,
   ...
   public ArrayList<HistoryBean> parseJokeByStream(Context context,
         InputStream in)
   {
      try
      {
   ...
   public ArrayList<HistoryBean> parseJokeByData(Context context, String Data)
   {
      try
      {
         lists.clear();
         ...
         Attributes attributes) throws SAXException
   {
      if (qName.equals("item") || "item".equals(localName))
      {
         ...
         HistoryBean rb = new HistoryBean(filePath,fileName);
         lists.add(rb);
      }
   }
