...
public class MusicIntentReceiver extends BroadcastReceiver
{
   ...
   public void onReceive(Context ctx, Intent intent)
   {
      ...
      {
//          Toast.makeText(ctx, "Headphones disconnected.",
//          Toast.LENGTH_SHORT).show();
         // send an intent to our MusicService to telling it to
         // pause the audio
         ctx.startService(new Intent(MediaPlayerService.ACTION_PAUSE));
      }
   }
}
