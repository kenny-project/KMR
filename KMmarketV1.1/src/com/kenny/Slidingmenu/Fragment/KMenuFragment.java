...
import com.byfen.market.HomeActivity;
import com.byfen.market.R;
import com.byfen.market.event.ExitEvent;
import com.framework.syseng.SysEng;
import com.work.market.adapter.KMenuAdapter;
import com.work.market.bean.FGroupInfo;
import com.work.market.bean.FileBean;
		...
		OnChildClickListener, OnClickListener
{
	...
	private void MenuInit()
	{
		...
		groupbean.AddDictBean(new KMenuItemBean(-1, "首页",KMenuItemBean.TYPE_HOMEPAGE_STATUS, null,
...
//	private HashMap<String, ContentFragment> mHashMap = new HashMap<String, ContentFragment>();
			...
			int groupPosition, int childPosition, long id)
	{
		...
		switch(bean.getType())
		{
		case KMenuItemBean.TYPE_HOMEPAGE_STATUS:
