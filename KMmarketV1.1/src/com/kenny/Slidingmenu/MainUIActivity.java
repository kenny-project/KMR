...
import com.kenny.Slidingmenu.Fragment.AbsFragmentPage;
...
public class MainUIActivity extends FragmentActivity
{
	...
	private void UMInit()
	{
		...
		MobclickAgent.setDebugMode(false);
		MobclickAgent.updateOnlineConfig(this);// ���߲�������
		MobclickAgent.onError(this);
		MobclickAgent.setSessionContinueMillis(10 * 60 * 1000);
		MobclickAgent.setAutoLocation(true);// collect location info,
...
//			getSlidingMenu().setTouchModeAbove(SlidingMenu.TOUCHMODE_NONE);
		...
		{
			HomeActivity localPage = new HomeActivity();
			mFragment = localPage;
			localPage.setTitle("SDcard"); //添加指定初始化数据 by wmh 
		}
...
//	}
	...
	public void switchContent(String key, final Fragment fragment)
	{
		...
		transaction.commit();
//		h.postDelayed(new Runnable()//by wmh
//		{
//			public void run()
//			{
...
//		}
	...
	public void setTitle(CharSequence title)
	{
		...
		//getSupportActionBar().setTitle(title);//by wmh
