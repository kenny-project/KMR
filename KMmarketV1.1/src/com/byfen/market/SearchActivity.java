	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		m_SearchButton.setOnClickListener(new View.OnClickListener()
		{
			...
			public void onClick(View v)
			{
				...
				{
					Toast.makeText(m_Context, "���벻��Ϊ��", Toast.LENGTH_LONG)
							.show();
				}
			}
		});
			...
			else
			{
				...
				try
				{
					...
					for (int i = 0; i < jsonObj1.length(); i++)
					{
						...
						String pn = tempJson.getString("pn");// package��
						String logo = tempJson.getString("logo");// ͼƬ��ַ
						String size = tempJson.getString("size");// �ļ���С(�ֽ�)score
						String score = tempJson.getString("score");// �ļ���С(�ֽ�)
						String apkurl = tempJson.getString("apkurl");// ���ص�ַ
						String dc = tempJson.getString("dc");// ���ش���
				...
				{
					Toast.makeText(lyKeyPanel.getContext(), "δ�鵽��Ӧ�Ľ��", Toast.LENGTH_LONG).show();
				}
				pd.dismiss();
			}
		}
