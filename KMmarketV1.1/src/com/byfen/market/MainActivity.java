...
//
//public class MainActivity extends ContentFragment implements OnClickListener
//{
//
//	public TabHost mHost;
//	public static RadioButton rankButton;// �һ�
//	public static RadioButton indexButton;// ��ҳ
//
...
//			if (Common.new_num != 0)
//			{
//				m_text4.setText("����(" + Common.new_num + ")");
//			}
//			m_image5.setImageResource(R.drawable.tab_more_normal);
//			m_text5.setTextColor(getResources().getColor(R.color.black));
