...
public class BaiduFileAdapter extends BaseAdapter
{
   ...
   public BaiduFileAdapter(Context context, List<BaiduFile> mFileList)
   {
      mContext = context;
   ...
   public BaiduFile getItem(int position)
   {
...
//         }
         ...
         OnClickListener
   {
	   BaiduFile tmpInfo;
      ViewHolder holder;
      public OnKCheckedChangeListener(ViewHolder holder,BaiduFile tmpInfo)
      {
