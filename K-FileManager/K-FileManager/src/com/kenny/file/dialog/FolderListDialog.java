 ...
 * 
 */
public class FolderListDialog implements OnItemClickListener
{
	...
	public void ShowDialog(Context context, String path,
			List<FileBean> mSrcFileList, final INotifyDataSetChanged notify)
	{
		mContext = context;
		this.mSrcFileList = mSrcFileList;
		manager.setContext(context);
		manager.setFilePath(path);
		// alertDialog = new CustomDialog(context, R.style.NobackDialog);
		...
		customBuilder.setTitle("标题")
				...
				.setPositiveButton(context.getResources().getString(R.string.ok), new DialogInterface.OnClickListener()
				{
					public void onClick(DialogInterface dialog, int which)
					{
						notify.NotifyDataSetChanged(Finish,
		...
		customBuilder.addView(alertView);
		View lyMain = alertView.findViewById(R.id.lyMain);
		lyMain.setBackgroundResource(Theme.getBackgroundResource());
		mCurrentPath = alertDialog.getTitleView();//(TextView) alertView.findViewById(R.id.mCurrentPath);

		lvFolderlist = (ListView) alertView.findViewById(R.id.lvFolderlist);
		lvFolderlist.setBackgroundResource(Theme.getBackgroundResource());
		...
		// LayoutParams p = alertDialog.getWindow().getAttributes();
		// //获取对话框当前的参数值
