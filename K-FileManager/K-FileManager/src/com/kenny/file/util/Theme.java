...
public class Theme
{
  ...
  */
   ...
   public static int getBackgroundResource()
   {
	...
	public static int getBackgroundResource(int ThemeMode)
	{
		switch (ThemeMode)
		{
		case 0:// 默认
   ...
   public static void setShowHideFile(boolean showHideFile)
   {
	...
	public static void Save(Context inActivity)
	{
		...
		SaveData.Write(inActivity, Const.strSensorEnable,
				getScreenOrientation());// 旋转
	...
	private static void ThemeMode(int ThemeMode)
	{
		...
		case Theme_Mode_BlackColor:// 黑色
			...
			break;
		case Theme_Mode_PagerColor:// 纸浆色
			...
			break;
		case Theme_Mode_greenColor:// 豆沙绿
		...
		case Theme_Mode_pinkColor:// 粉红色
			...
			break;
		case Theme_Mode_yellowColor:// 黄色
