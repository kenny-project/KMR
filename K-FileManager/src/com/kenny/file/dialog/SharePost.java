...
public class SharePost extends Dialog implements OnClickListener,
      android.view.View.OnClickListener, OnItemClickListener
{
   ...
   public SharePost(Activity context)
   {
      super(context);
   ...
   public void onCreate(Bundle savedInstanceState)
   {
      ...
      nFlag = SaveData.Read(getContext(),
	  "LocalAddressDialog_flag", 0);
      this.setOnCancelListener(new OnCancelListener()
      {
         ...
         public void onCancel(DialogInterface dialog)
         {
	      ...
	      SaveData.Write(getContext(), "LocalAddressDialog_flag",
		  nFlag);
         }
      });
      FavoriteInit(nFlag);
   ...
   public void DeleteData()
   {
      ...
      for (int i = 0; i < mFileList.size(); i++)
      {
         ...
         {
	  mFileList.remove(i);
	  dao.deleteFavorite(tmpInfo.getId());
         }
      }
      dao.closeDb();
      mFileAdapter.notifyDataSetChanged();
