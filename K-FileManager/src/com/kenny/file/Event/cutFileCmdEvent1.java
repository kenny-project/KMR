...
//
//public class cutFileCmdEvent1 extends AbsEvent {
...
//
//	public cutFileCmdEvent1(Context context, String mCurrentPath,
...
//<<<<<<< .mine
//
//				int result = MoveFile(mCurrentPath, mSrcFile.getFile());
//>>>>>>> .r133
//				P.v("result=" + result);
//<<<<<<< .mine
//				if (result > 0) {
...
//	 */
//	private int cutFile(String directory, File file) {
//		try {
//			if (file.exists()) {
//				String newPath = directory + "/" + file.getName();
