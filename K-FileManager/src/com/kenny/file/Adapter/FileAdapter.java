...
public class FileAdapter extends BaseAdapter
{
   ...
   public FileAdapter(Context context, int nFlag, List<FileBean> mFileList,INotifyDataSetChanged notify)
   {
      mContext = context;
      this.nFlag = nFlag;
      this.notify=notify;
   ...
   public View getGridView(int position, View convertView, ViewGroup viewgroup)
   {
	  ...
	  viewHolder.mCB
	        .setOnClickListener(new OnKCheckedChangeListener(convertView,temp));
         }
         else
         {
	  viewHolder.mCB.setVisibility(View.GONE);
...
//         }
	  ...
	  //convertView.setBackgroundColor( mContext.getResources().getColor(R.color.list_bg));
         }
   ...
   protected class OnKCheckedChangeListener implements
         OnClickListener
   {
	  ...
	  if(notify!=null)
	  {
	     notify.NotifyDataSetChanged(Const.cmd_Local_List_Selected, tmpInfo);
	  }
         }
         else
         {
	  ...
	  if(notify!=null)
	  {
	     notify.NotifyDataSetChanged(Const.cmd_Local_List_UnSelected, tmpInfo);
	  }
	  }
         }
      }
