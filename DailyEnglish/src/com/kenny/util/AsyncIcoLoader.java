...
public class AsyncIcoLoader
{
    ...
    public static AsyncIcoLoader GetObject(Context ctx)
    {
        m_object.m_ctx=ctx;
        return m_object;
    }
            ...
            final ImageCallback callback)
    {
        ...
        image = SDFile.ReadSDLogoFile(m_ctx, imageUrl);
        if (image != null)
        {
    ...
    protected Drawable loadImageFromUrl(String imageUrl)
    {
        try
        {
            ...
            {
            if(T.checkSDCard())
            SDFile.WriteSDLogoFile(m_ctx,imageUrl,bitmap);
            ...
            {
            	Log.v("wmh", "error:imageUrl="+imageUrl);
            	return null;
            }
        }
        catch (Exception e)
