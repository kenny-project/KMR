...
public class V6Feedback extends Activity {
	...
	private void initView() {
			...
			public void onClick(View v) {
				...
				if (etContent.hasFocus()) {
					SysEng.getInstance().runEvent(
							new ShowOrHideInputpadEvent(V6Feedback.this,
									etContent, false));
		...
		btnSend.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Log.e("CHANNEL_NUM",
						"CHANNEL_NUM is "
								+ Utils.getChannelNum(V6Feedback.this));
	...
	private void sendFeedBack() {
		if (Utils.isNetConnect(V6Feedback.this) == false) {
			return;
		}
		...
		SysEng.getInstance().runEvent(
				new ShowOrHideInputpadEvent(V6Feedback.this, etContent, false));
	...
	private void showFeedbackContentErrorToast() {
		Toast.makeText(
				V6Feedback.this,
				V6Feedback.this.getResources().getString(
