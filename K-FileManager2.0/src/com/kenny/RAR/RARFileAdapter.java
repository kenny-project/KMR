...
/** 自定义Adapter内部 */
public class RARFileAdapter extends BaseAdapter
{
	private Context mContext;
	private List<RARFileBean> mFileList;
	...
	public RARFileAdapter(Context context, int nFlag,
			List<RARFileBean> mFileList)
	{
		mContext = context;
		this.nFlag = nFlag;
		if (nFlag == 1)
