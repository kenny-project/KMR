...
public class SearchResultPage extends MultiItemPage implements
		OnItemClickListener, INotifyDataSetChanged, OnClickListener, IManager
{
	...
	public void onCreate()
	{
		...
		final SimpleAdapter modeAdapter = new SimpleAdapter(getContext(), data,
			...
			ArrayList<FileBean> list)
	{
		...
		for (int i = 0; i < list.size(); i++)
		{
			try
			{
				...
				FileEnd result = null;
				if (file.isDirectory()&&fileEnds == null || fileEnds.length() < 1)
				{
					continue;
				}
