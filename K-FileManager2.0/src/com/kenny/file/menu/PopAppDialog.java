...
public class PopAppDialog
{
			...
			{// item的值就是从0开始的索引值(从列表的第一项开始)
				...
				{// 注意，所有对文件的操作必须是在该文件可读的情况下才可以，否则报错
					...
					case 2:
						...
						break;
					case 3: // 属性
						ApkTools.showAppDetails(context,
	...
	/** 长按文件或文件夹时弹出的带ListView效果的功能菜单 */
	public static void ShowFile(final Activity context, final FileBean mAppInfo,
			...
			{// item的值就是从0开始的索引值(从列表的第一项开始)
				...
				{// 注意，所有对文件的操作必须是在该文件可读的情况下才可以，否则报错
					...
					case 0: // 打开
						...
						{
							SysEng.getInstance().addHandlerEvent(
									new openFileEvent(context, mAppInfo
											.getFilePath()));
						} else
						{
							Toast.makeText(
					...
					case 2:// 删除
						...
						break;
					case 3: // 属性
						KDialog.ShowDetailsDialog(context,
								mAppInfo.getFilePath());
						break;
					}
				} else
