 ...
 * @author wmh 初始化event
 * */
public class LoadAppsProgressDialogEvent extends AbsEvent {
	...
	public LoadAppsProgressDialogEvent(Activity act, int nFlag,
			ArrayList<AppBean> beans, boolean bShowDialog,
