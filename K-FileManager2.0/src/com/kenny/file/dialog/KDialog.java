...
public class KDialog
{
			...
			String szNegative, OnClickListener clNegative)
	{
		...
		if (szPositive != null)
			builer.setPositiveButton(szPositive, clPositive);
		if (szNegative != null)
			builer.setNegativeButton(szNegative, clNegative);
	...
	public static void ShowDetailsDialog(final Context m_ctx, String path)
	{
		...
		final View textEntryView = factory.inflate(R.layout.details_dialog,
				null);
		...
		tvFileSize.setText(T.FileSizeToString(StorageUtil.getFreeSpace(file)));
